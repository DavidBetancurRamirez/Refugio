...
public class PanelAddAdopcion extends JPanel {
	...
	public void getInfo(Animal a, Cliente c, Refugio r) {
	...
	public String getIdAnimal() {
		return lblGetId.getText();
	}
	public String getCcCliente() {
		return lblGetCc.getText();
	}
	public String getIdAdocpcion() {
